...
public class BloqueandoCasinha : MonoBehaviour
{
    ...
    {
        if (_jogada == true && _ocupado == false && _jogavel == true && _bloqueado == false) //So ficara disponivel para clicar se comprir essas condi��es
        {
            _selecionavel = true;
    ...
    public bool SelecionandoBlock()
    {
        ...
        else
        {
            ...
            //Verificar se ja esta bloqueado(tem que ser falso pra continuar)
